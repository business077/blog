...
function App() {
  ...
  return (
    <div className="app-shell" ref={pageRef} onPointerMove={trackPagePointer}>
      <div className="visual-atmosphere" aria-hidden="true"><div className="ambient-orb ambient-orb-a"></div><div className="ambient-orb ambient-orb-b"></div><div className="ambient-orb ambient-orb-c"></div><div className="ambient-ring"><div className="ambient-ring-inner"></div></div><div className="background-orbits"><div className="orbit-core"></div><div className="orbit-path orbit-path-one"><i></i></div><div className="orbit-path orbit-path-two"><i></i></div><div className="orbit-path orbit-path-three"><i></i></div></div><div className="space-traffic"><div className="rocket rocket-one"><span></span></div><div className="rocket rocket-two"><span></span></div><div className="satellite satellite-one"><span></span></div><div className="tiny-astronaut"><div className="astronaut-bubble">HELLO</div><div className="astronaut-helmet"></div><div className="astronaut-body"></div><div className="astronaut-pack"></div><div className="astronaut-boot boot-one"></div><div className="astronaut-boot boot-two"></div></div><div className="friendly-alien alien-one"><span className="alien-eye eye-one"></span><span className="alien-eye eye-two"></span><span className="alien-antenna antenna-one"></span><span className="alien-antenna antenna-two"></span></div><div className="friendly-alien alien-two"><span className="alien-eye eye-one"></span><span className="alien-eye eye-two"></span><span className="alien-antenna antenna-one"></span><span className="alien-antenna antenna-two"></span></div><div className="read-beacon"><span>READ ROHIT'S BLOG</span><i></i></div></div><div className="ambient-scan"></div><div className="ambient-stars">{Array.from({ length: 30 }, (_, index) => <i key={index}></i>)}</div></div>
